								...
								<tbody>
									...
									<?php $__currentLoopData = $hotspotuser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $no => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								  	...
								  	<tr align="center">
                                        ...
                                        <td>
                                            <span class="badge text-light <?php echo e($data['disabled'] == 'false' ? 'bg-success':'bg-danger'); ?> ">
                                            <?php echo e(($data['disabled'] == 'false') ? 'Aktif':'Tidak Aktif'); ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\File Rheza\gmedia-project\resources\views/voucher.blade.php ENDPATH**/ ?>