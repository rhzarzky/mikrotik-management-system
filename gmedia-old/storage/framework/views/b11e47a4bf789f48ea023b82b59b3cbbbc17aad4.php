...
<div class="container">  
    <h1 class="mt-4">Detail Pembelian Paket</h1>
      <a href="<?php echo e(route('goback')); ?>" class="btn btn-light btn-sm">
        <i class="fas fa-circle-chevron-left"></i>&nbsp;Kembali</a>
        <br><br>
        <div class="card shadow" style="width: 23rem;">
            <div class="card-body">
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active"> <?php echo e($paket); ?></li>
                </ol>
            <form action="<?php echo e(route('bayar.post')); ?>" method="POST" enctype="multipart/form-data">
                <!-- check out -->
                <?php echo csrf_field(); ?>
              <div class="save">
                  <label for="save">Username &nbsp; : </label>
                      <input readonly type="text" id="save" name="username" value="<?php echo e($username); ?>" size="16">
                  <label for="save">Password &nbsp; &nbsp;: </label>
                        <input readonly type="text" id="save" name="password" value="<?php echo e($password); ?>" size="16">
                  <label for="save">Profile  &emsp; &emsp; :</label>
                        <input readonly type="text" id="save" name="profile" value="<?php echo e($paket); ?>" size="16">
                  <label for="save">Time Limit &nbsp; : </label>
                        <input readonly type="text" id="save" name="limit" value="<?php echo e($durasi); ?> " size="16">
                  <label for="save">Total &emsp; &emsp; &nbsp; : &nbsp;Rp</label>
                        <input readonly type="text" id="save" name="price" value="<?php echo e($harga); ?>" size="12" > 
...
<?php echo $__env->make('landing-page.layout.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\gmedia-pbl\gmedia-project\GMEDIA\resources\views/landing-page/checkout.blade.php ENDPATH**/ ?>