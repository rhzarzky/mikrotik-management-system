...
<div class="container"> 
        <div class="card" style="width: 20rem;">
            <div class="card-body">
                <img src="<?php echo e(asset('template-dashboard')); ?>/assets/img/logo.png" alt="Logo" width="80px"><br>

                <!-- check out -->
                  <table>
                    <tr>
                      <td>Username</td>
                      <td> &nbsp : &nbsp <?php echo e($data->username); ?></td>
                    </tr>
                    <tr>
                      <td>Password</td>
                      <td>&nbsp  : &nbsp <?php echo e($data->password); ?></td>
                    </tr>
                    <tr>
                      <td>Paket</td>
                      <td> &nbsp : &nbsp <?php echo e($data->profile); ?></td>
                    </tr>
                    <tr>
                      <td>Durasi</td>
                      <td> &nbsp : &nbsp <?php echo e($data->limit); ?></td>
                    </tr>
                  </table>
...
</html><?php /**PATH D:\gmedia-pbl\gmedia-project\GMEDIA\resources\views/landing-page/pdf.blade.php ENDPATH**/ ?>