<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark bg-gradient shadow">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="<?php echo e(route('landing-page.index')); ?>">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark shadow" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="<?php echo e(route('interface')); ?>">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?php echo e(route('voucher')); ?>">Voucher</a>
                                    <a class="nav-link" href="<?php echo e(route('active')); ?>">Status</a>
                                    <a class="nav-link" href="<?php echo e(route('scheduler')); ?>">Scheduler</a>
                                </nav>
                            </div>
                            ...
                            <?php if(Auth::check() && Auth::user()->level == 'admin'): ?>
                            <a class="nav-link" href="<?php echo e(route('mitra')); ?>">
        ...
        </div><?php /**PATH D:\gmedia-pbl\gmedia-project\GMEDIA\resources\views/layout/navbar.blade.php ENDPATH**/ ?>