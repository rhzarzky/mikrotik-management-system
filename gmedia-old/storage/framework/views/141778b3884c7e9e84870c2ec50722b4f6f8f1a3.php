        ...
        <div class="card shadow" style="width: 23rem;">
            <div class="card-body">
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active"> <?php echo e($data->profile); ?></li>
                </ol>
              <div class="save">
                  <label for="save">Username &nbsp; : </label>
                      <input readonly type="text" id="save" name="username" value="<?php echo e($data->username); ?>" size="16">
                  ...
                  <label for="save">Time Limit &nbsp; : </label>
                        <input readonly type="text" id="save" name="limit" value="<?php echo e($data->limit); ?>" size="16">
                  <label for="save">Total &emsp; &emsp; &nbsp; : &nbsp;Rp</label>
                        <input readonly type="text" id="save" name="price" value="<?php echo e($data->price); ?>" size="12" > 
                  <label for="save">Status &emsp; &nbsp;  &nbsp; : &nbsp;</label>
                       <input readonly type="text" id="save" value="<?php echo e($data->status); ?>" name="status" size="16" >
                </div>
                 <!--  Cara transaksi --> 

                      <a href="<?php echo e(route('pdf', $data->id)); ?>" class="btn btn-success btn-lg mb-2 float-right" target="_download">
...
<?php echo $__env->make('landing-page.layout.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\gmedia-pbl\gmedia-project\GMEDIA\resources\views/landing-page/invoice.blade.php ENDPATH**/ ?>