<!-- ======= Header ======= -->
          ...
          <?php if(auth()->guard()->check()): ?>
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="profileDropdown">
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('router')); ?>">Dashboard</a>
                        <!-- Form untuk Logout -->
  ...
  <?php echo $__env->yieldContent('content'); ?><?php /**PATH D:\gmedia-pbl\GMEDIA SERVER\GMEDIA\resources\views/landing-page/layout/navbar.blade.php ENDPATH**/ ?>