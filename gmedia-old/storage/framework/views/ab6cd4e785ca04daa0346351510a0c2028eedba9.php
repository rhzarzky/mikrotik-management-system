 ...
 <?php $__env->startSection('title','Gmedia.Net - Mitra'); ?>
...
<div id="layoutSidenav_content">
 	<main>
        ...
        <!-- Modal add-->
                ...
                <!--  Form add -->
                        <form action="<?php echo e(route('addmitra.post')); ?>" method="POST" >
                            <?php echo csrf_field(); ?> 
                            ...
                            <table id="datatablesSimple">
							    ...
							    <tbody>
                                    <?php $__currentLoopData = $datausers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $no => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <!--  button hapus -->
                                                <a href="<?php echo e(route('deleteMitra', $item->id)); ?>" class="btn btn-link btn-lg" id="deletemitra" data-nama="<?php echo e($item->username); ?>">
                        ...
                        <div class="modal fade" id="edit<?php echo e($item->id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                          <div class="modal-dialog">
                            ...
                            <!--  Form Edit -->
                              ...
                              <div class="modal-body">
                                <form action="<?php echo e(route('mitra.edit', $item->id)); ?>" method="POST" >
                                <?php echo csrf_field(); ?> 
                                    <div class="form-floating mb-3">
                                        <input type="email" class="form-control" name="email" value="<?php echo e($item -> email); ?>" placeholder="Masukkan email" required>
...
<?php echo $__env->make('layout.supermaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\gmedia-pbl\GMEDIA SERVER\GMEDIA\resources\views/mitra.blade.php ENDPATH**/ ?>