                        ...
                        <div class="modal fade" id="edit<?php echo e($item->id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                          <div class="modal-dialog">
                            ...
                            <!--  Form Edit -->
                              ...
                              <div class="modal-body">
                                <form action="<?php echo e(route('ubah',  $item->id)); ?>" method="POST" >
                                <?php echo csrf_field(); ?> 
                                    <div class="form-floating mb-3">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="email" class="form-control" name="email" value="<?php echo e($item -> address); ?>" placeholder="Masukkan email" required>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\gmedia-pbl\gmedia-project\GMEDIA\resources\views/mitra.blade.php ENDPATH**/ ?>