 ...
 <?php $__env->startSection('title','Gmedia.Net - Voucher'); ?>
 	...
 	<main>
        ...
        <!-- Modal pemesanan mitra-->
                ...
                <!--  Form add -->
                        ...
                        <form action="<?php echo e(route('PesanVoucher.post')); ?>" method="POST" >
                        <?php echo csrf_field(); ?> 
                            <div class="form-floating mb-3"> 
                                <input hidden type="text" class="form-control" name="status" value="Pending" required>
                                <?php $__currentLoopData = $datausers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($item->username == auth()->user()->username): ?>   
           ...
           <!--  close modal pemesanan-->
            ...
            <!-- Modal add-->
                ...
                <!--  Form add -->
                        ...
                        <form action="<?php echo e(route('addvoucher.post')); ?>" method="POST" >
                        <?php echo csrf_field(); ?> 
                ...
                <div class="modal fade" id="generatevoucher" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                <!--  Form add -->
                        <form action="<?php echo e(route('generatevoucher.post')); ?>" method="POST" >
                        <?php echo csrf_field(); ?>
                            <div class="form-floating mb-3">
                                <input type="hidden" class="form-control" name="disabled" value="true">
               ...
               <!--  Data Voucher/user -->
                <div class="card mb-4">
                            ...
                            <table id="datatablesSimple">
								...
								<tbody>
                                    <?php
                                        $kounter = 1;
                                    ?>
									<?php $__currentLoopData = $hotspotuser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $no => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(isset($data['comment']) && $data['comment'] == $item1): ?>
								  	...
								  	<tr align="center">
										...
										<td> <?php echo e($data['profile'] ?? ''); ?> </td>
                                        <td> <?php echo e($data['uptime']); ?> </td>
                                        <td> <?php echo e($data['limit-uptime'] ?? 'unlimited'); ?> </td>
                                        <td>
                                            <span class="badge text-light <?php echo e($data['disabled'] == 'false' ? 'bg-danger':'bg-success'); ?> ">
                                            <?php echo e(($data['disabled'] == 'false') ? 'Terjual':'Tersedia'); ?>
                                        ...
                                        <!-- button edit -->
                                                <a class="btn btn-link btn-lg" data-bs-toggle="modal" data-bs-target="#edit<?php echo e($id); ?>">
                                                    <i class="fa fa-edit"></i>
                                                </a>

                                        <!--  button hapus -->
                                                <a href="<?php echo e(route('deletevoucher', $id)); ?>" class="btn btn-link btn-lg" id="delete" data-nama="<?php echo e($data['name']); ?>">
                                                    <i class="fa fa-times"></i>
                                                </a>

                                        <!--  button transaksi -->
                                                <button class="btn btn-link btn-lg" id="btnTransaksi<?php echo e($id); ?>" data-bs-toggle="modal" data-bs-target="#transaksi<?php echo e($id); ?>">
                                                    <i class="fa fa-cart-shopping"></i>
                                                </button>

                                        <!--   Disable Button -->
                                                <script type="text/javascript">
                                                    <?php if($data['disabled'] == 'false'): ?>
                                                        document.getElementById('btnTransaksi<?php echo e($id); ?>').disabled = true;
                                                    <?php else: ?>
                                                        document.getElementById('btnTransaksi<?php echo e($id); ?>').disabled = false;
                                                    <?php endif; ?>
                                                </script>
                                        <!--   Disable Button -->
                                            </div>
                    ...
                    <!-- Modal transaksi-->
                        ...
                        <div class="modal fade" id="transaksi<?php echo e($id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                          <div class="modal-dialog" style="width: 21rem;">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Invoice <?php echo e($data['name'] ?? ''); ?></h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                              </div>
                              ...
                              <div class="modal-body">
                                <div class="card shadow" style="width: 19rem;">
                                    <div class="card-body">
                                        ...
                                        <form action="<?php echo e(route('save.post')); ?>" method="POST" >
                                         <?php echo csrf_field(); ?> 
                                            <div class="save">
                                                <label for="save">Username &nbsp;: </label>
                                                    <input type="hidden" value="<?= $data['.id'] ?>" name="id">
                                                    <input type="hidden" name="disabled" value="<?php echo e($data['disabled']); ?>">
                                                    <input type="hidden" name="bukti_bayar" value="offline">
                                                    <input type="hidden" name="user_id" value="<?php echo e($data['comment']); ?>">
                                                    <input readonly type="text" id="save" name="user" value="<?php echo e($data['name'] ?? ''); ?>" size="16">
                                                <label for="save">Password &nbsp; : </label>
                                                    <input readonly type="text" id="save" name="password" value="<?php echo e($data['password'] ?? ''); ?>" size="16">
                                                <label for="save">Profile  &emsp; &nbsp; :</label>
                                                    <input readonly type="text" id="save" name="profile" value="<?php echo e($data['profile'] ?? ''); ?>" size="16">
                                                <label for="save">Time Limit : </label>
                                                    <input readonly type="text" id="save" name="timelimit" value="<?php echo e($data['limit-uptime'] ?? 'unlimited'); ?> " size="16">
                                            <hr>
                                                <b>
                                                    <?php if($data['profile'] == 'Streaming'): ?> 
                                                        <?php if($data['limit-uptime'] == '1d'): ?>
                                                            <label for="save">Total &emsp; &nbsp; &nbsp; : &nbsp;Rp</label>
                                                            <input readonly type="text" id="save" name="comment" 
                                                            value="6000" size="12" style="font-weight: bold;"> 
                                                        <?php elseif($data['limit-uptime'] == '6h'): ?>
                                                            <label for="save">Total &emsp; &nbsp; &nbsp; : &nbsp;Rp</label>
                                                            <input readonly type="text" id="save" name="comment" 
                                                    ...
                                                    <?php elseif($data['profile'] == 'Social Media'): ?>
                                                        <?php if($data['limit-uptime'] == '1d'): ?>
                                                           <label for="save">Total &emsp; &nbsp; &nbsp; : &nbsp;Rp</label>
                                                            <input readonly type="text" id="save" name="comment" 
                                                            value="5000" size="12" style="font-weight: bold;"> 
                        ...
                        <!--   Tata cara transaksi -->
                                ...
                                <!--   Button cetak -->
                                        <a href="<?php echo e(route('printvoucher', $id)); ?>" type="button" data-toggle="tooltip" target="_blank"   class="btn btn-secondary">
                   ...
                   <!--  close modal transaksi --> 
                    ...
                    <!-- Modal edit-->
                        ...
                        <div class="modal fade" id="edit<?php echo e($id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                            ...
                            <!--  Form Edit -->
                              ...
                              <div class="modal-body">
                                <form action="<?php echo e(route('updatevoucher.post')); ?>" method="POST" >
                                <?php echo csrf_field(); ?> 
                                    <div class="form-floating mb-3">
                                        <input type="hidden" value="<?= $data['.id'] ?>" name="id">
                                        <input type="text" class="form-control" name="user" value="<?php echo e($data['name'] ?? ''); ?>" placeholder="Masukkan user" required>
                                        <label class="form-label" for="user">User</label>
                                    </div>
                                     <div class="form-floating mb-3"> 
                                        <input type="text" class="form-control" name="password" value="<?php echo e($data['password'] ?? ''); ?>" placeholder="Masukkan password" required>
                                        <label class="form-label">Password</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <select name="profile" class="form-control" required>
                                            <option disabled selected>--Pilih Profile--</option>
                                                <?php if($pilihan = $data['profile'] ?? '' ): ?>
                                            <?php $__currentLoopData = $profile; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?= ( $pilihan == $item['name'] ) ? "selected": "" ?> ><?php echo e($item['name']); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                        </select>
                                    ...
                                    <div class="form-floating mb-3"> 
                                         <select class="form-control" name="timelimit" placeholder="Masukkan timelimit" required>
                                            ...
                                            <?php if($pilihan = $data['limit-uptime'] ?? 'unlimited' ): ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\gmedia-pbl\gmedia-project\GMEDIA\resources\views/voucher.blade.php ENDPATH**/ ?>