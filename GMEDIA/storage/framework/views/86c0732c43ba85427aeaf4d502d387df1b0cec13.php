...
<head>
  ...
  <link rel="shortcut icon" type="image/jpeg" href="<?php echo e(asset('template-dashboard')); ?>/assets/img/favicon.png">
  <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
  <link href="https://cdn.jsdelivr.net/npm/simple-datatables@latest/dist/style.css" rel="stylesheet" />
  <link href="<?php echo e(asset('template-dashboard')); ?>/css/styles.css" rel="stylesheet" />
...
<body class="sb-nav-fixed bg-light">
  ...
  <script src="<?php echo e(asset('template-dashboard')); ?>/js/scripts.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js" crossorigin="anonymous"></script>
  <script src="<?php echo e(asset('template-dashboard')); ?>/assets/demo/chart-area-demo.js"></script>
  <script src="<?php echo e(asset('template-dashboard')); ?>/assets/demo/chart-bar-demo.js"></script>
  <script src="https://cdn.jsdelivr.net/npm/simple-datatables@latest" crossorigin="anonymous"></script>
  <script src="<?php echo e(asset('template-dashboard')); ?>/js/datatables-simple-demo.js"></script>
  <script type="text/javascript" src="<?php echo e(asset('template-dashboard')); ?>/js/jquery-3.6.0.min.js"></script>
  <script type="text/javascript" src="<?php echo e(asset('/')); ?>highchart/js/highcharts.js"></script>
...
</html><?php /**PATH D:\File Rheza\gmedia-project\GMEDIA\resources\views/layout/master.blade.php ENDPATH**/ ?>