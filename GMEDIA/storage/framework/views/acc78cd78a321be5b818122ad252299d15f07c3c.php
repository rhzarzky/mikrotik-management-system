                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-4">
                                 ...
                                 <!--  Alert Session -->
                                    ...
                                    <div class="card-header bg-info bg-gradient">
                                        <img src="<?php echo e(asset('template-dashboard')); ?>/assets/img/logo.png" class="mx-auto d-block" width="210px">
                                    </div>
                                    <div class="card-body">
...
<html lang="en">
  ...
  <body class="container col-md-5">
      ...
      <div class="alert-light">
        <i class="fas-solid fa-triangle-exclamation"></i><?php echo e(Session::get('light')); ?>

       </div>
      <?php endif; ?> 
        <form class="form-control mt-5" action="<?php echo e(route('login.post')); ?>" method="POST" >
          <?php echo csrf_field(); ?>
 ...
 --><?php /**PATH D:\File Rheza\gmedia-project\GMEDIA\resources\views/auth/login.blade.php ENDPATH**/ ?>