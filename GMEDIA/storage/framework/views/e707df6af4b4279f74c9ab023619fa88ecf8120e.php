 ...
 <?php $__env->startSection('title','Gmedia.Net'); ?>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
          <img src="<?php echo e(asset('template-landing-page')); ?>/assets/img/hero-img.png" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="zoom-in">
          ...
          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo e(asset('template-landing-page')); ?>/assets/img/clients/client-1.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo e(asset('template-landing-page')); ?>/assets/img/clients/client-2.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo e(asset('template-landing-page')); ?>/assets/img/clients/client-3.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo e(asset('template-landing-page')); ?>/assets/img/clients/client-4.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo e(asset('template-landing-page')); ?>/assets/img/clients/client-5.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo e(asset('template-landing-page')); ?>/assets/img/clients/client-6.png" class="img-fluid" alt="">
          </div>
    ...
    <section id="why-us" class="why-us section-bg">
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row">
          ...
          style='background-image: url("<?php echo e(asset("template-landing-page")); ?>/assets/img/why-us.png")' data-aos="zoom-in" data-aos-delay="150">&nbsp;</div>
        </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
            <img src="<?php echo e(asset('template-landing-page')); ?>/assets/img/skills.png" class="img-fluid" alt="">
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="box shadow">
              ...
              <a href="<?php echo e(route('landing-page.form-sosmed')); ?>" class="buy-btn">Beli sekarang</a>
            </div>
          </div>
           ...
           <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="300">
            <div class="box shadow">
              ...
              <a href="<?php echo e(route('landing-page.form-streaming')); ?>" class="buy-btn">Beli sekarang</a>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="300">
            <div class="box shadow">
              ...
              <a href="<?php echo e(route('landing-page.form-game')); ?>" class="buy-btn">Beli sekarang</a>
            </div>
          </div>
...
<?php echo $__env->make('landing-page.layout.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

  <div id="preloader"></div>
  <a href="#" class="back-to-top d-flex align-items-center justify-content-center"><i class="bi bi-arrow-up-short"></i></a>

 <?php $__env->stopSection(); ?>
<?php echo $__env->make('landing-page.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\File Rheza\gmedia-project\GMEDIA\resources\views/landing-page/index.blade.php ENDPATH**/ ?>