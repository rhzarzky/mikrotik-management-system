											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group form-group-default">
														...
														<input name="local-address" id="local-address" type="text" class="form-control" placeholder="Local Address">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group form-group-default">
														<label>Remote Address</label>
														<input name="remote-address" id="remote-address" class="form-control" placeholder="Remote Address">
													</div>
												</div>
												<div class="col-sm-12">
