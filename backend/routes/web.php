...
//Hotspot User
Route::get('hotspot/user', [HotspotController::class, 'index'])->name('hotspot.user');
Route::post('hotspot/user/add', [HotspotController::class, 'add'])->name('hotspot.add');
Route::get('hotspot/user/edit/{id}', [HotspotController::class, 'edit'])->name('hotspot.edit');
Route::post('hotspot/user/update', [HotspotController::class, 'update'])->name('hotspot.update');
Route::get('hotspot/user/delete/{id}', [HotspotController::class, 'delete'])->name('hotspot.delete');
